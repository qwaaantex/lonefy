...
class RegisterChildrenTextFormField extends StatefulWidget {
  ...
  @override
  State<RegisterChildrenTextFormField> createState() =>
      _RegisterChildrenTextFormFieldState();
}

class _RegisterChildrenTextFormFieldState
    extends State<RegisterChildrenTextFormField> {
            ...
            validator: (value) {
              if (value!.isEmpty || provider.controllerEmail.text.isEmpty) {
                return S.of(context).EmailIsNotEmpty;
                  ...
                  !provider.controllerEmail.text.contains("@")) {
                return S.of(context).EmailMustContain;
              } else if (value.length <= 3 ||
                  provider.controllerEmail.text.length <= 3) {
                return S.of(context).EmailMustBeLonger;
              } else if (value.length > 18 ||
                  provider.controllerEmail.text.length < 18) {
                return S.of(context).EmailIsToLonger;
              }
              return null;
            },
            ...
            validator: (value) {
              if (value!.isEmpty || provider.controllerPassword.text.isEmpty) {
                return S.of(context).PasswordIsNotEmpty;
                  ...
                  provider.controllerPassword.text.length <= 6) {
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                icon: AnimatedSwitcher(
                  ...
                  child: Icon(
                    key: ValueKey(isConfidentyPassword),
                    isConfidentyPassword == false
